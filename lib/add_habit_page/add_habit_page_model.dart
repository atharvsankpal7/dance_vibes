...
class AddHabitPageModel extends FlutterFlowModel<AddHabitPageWidget> {
  ...
  String? _habitTitleTextControllerValidator(
  ...
  String? _habitReasonTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  // State field(s) for FrequencyInput widget.
  List<String>? frequencyInputValue;
  FormFieldController<List<String>>? frequencyInputValueController;
  DateTime? datePicked2;
  DateTime? datePicked3;

  @override
  void initState(BuildContext context) {
    habitTitleTextControllerValidator = _habitTitleTextControllerValidator;
    habitReasonTextControllerValidator = _habitReasonTextControllerValidator;
