...
class _AddHabitPageWidgetState extends State<AddHabitPageWidget>
  ...
  void initState() {
    ...
    _model.habitTitleTextController ??= TextEditingController();
    _model.habitTitleFocusNode ??= FocusNode();

    _model.habitReasonTextController ??= TextEditingController();
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.frequencyInputValue == null) {
                                return;
                              }
                                ...
                                ...mapToFirestore(
                                  {
                                    ...
                                    'frequency': _model.frequencyInputValue,
                                    'created_time':
                                        FieldValue.serverTimestamp(),
