...
class TaskRecord extends FirestoreRecord {
  ...
  // "subTasks" field.
  List<DocumentReference>? _subTasks;
  List<DocumentReference> get subTasks => _subTasks ?? const [];
  bool hasSubTasks() => _subTasks != null;
  ...
  void _initializeFields() {
    ...
    _subTasks = getDataList(snapshotData['subTasks']);
...
class TaskRecordDocumentEquality implements Equality<TaskRecord> {
  ...
  bool equals(TaskRecord? e1, TaskRecord? e2) {
    ...
    return e1?.owner == e2?.owner &&
        ...
        listEquality.equals(e1?.subTasks, e2?.subTasks) &&
